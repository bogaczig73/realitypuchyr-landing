...
export default function AboutVideoTour() {
    const t = useTranslations('components.aboutVideoTour');
    const [isOpen, setOpen] = useState(false)

    return (
        <>
            <section className='md:pb-24 pb-16 lg:mt-24 mt-16'>
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div className="md:col-span-7">
                        <div className="lg:ms-4">
                            ...
                            <div className="mt-4">
                                <Link href="/services" className="btn bg-green-600 hover:bg-green-700 text-white rounded-md mt-3">{t('learnMore')} <i className="mdi mdi-arrow-right ms-1 align-middle"></i></Link>
                            </div>
                        </div>
                    </div>
