...
export default function AboutOurCooperation() {
    const t = useTranslations('components.aboutCooperation');
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div className="md:col-span-7">
                        <div className="lg:ms-4">
                            <h4 className="mb-6 md:text-3xl text-2xl lg:leading-normal leading-normal font-semibold">{t('title')}</h4>
                            <p className="text-slate-400 max-w-xl">{t('description')}</p>

                            <div className="mt-4">
                                <Link href="/blog/jak-probiha-prodej-nemovitosti-kompletni-pruvodce" className="btn bg-green-600 hover:bg-green-700 text-white rounded-md mt-3">{t('moreAboutOurCooperation')} <i className="mdi mdi-arrow-right ms-1 align-middle"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
