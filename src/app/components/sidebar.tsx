                    ...
                    <SimpleBar style={{height: "calc(100% - 70px)"}}>
                        <ul className="sidebar-menu border-t border-white/10">
                            <li className={`${manu === "/" ? 'active' : ''} ms-0`}>
                                <Link href="/" onClick={toggleSidebar} scroll={false}><i className="mdi mdi-home me-2"></i>Home</Link>
                            </li>

                            <li className={`${manu === "/list" ? 'active' : ''} ms-0`}>
                                <Link href="/list" onClick={toggleSidebar} scroll={false}><i className="mdi mdi-home-city me-2"></i>Listing</Link>
                            </li>

                            <li className={`${manu === "/faq" ? 'active' : ''} ms-0`}>
                                <Link href="/faq" onClick={toggleSidebar} scroll={false}><i className="mdi mdi-help-circle me-2"></i>FAQ</Link>
                            </li>

                            <li className={`${manu === "/blog" ? 'active' : ''} ms-0`}>
                                <Link href="/blog" onClick={toggleSidebar} scroll={false}><i className="mdi mdi-post-outline me-2"></i>Blog</Link>
                            </li>

                            <li className={`${manu === "/contact" ? 'active' : ''} ms-0`}>
                                <Link href="/contact" onClick={toggleSidebar} scroll={false}><i className="mdi mdi-email me-2"></i>Contact</Link>
                            </li>
                            ...
                            <li className="ms-0 mt-4 px-5">
                                <Link href="tel:+420733781696" className="btn bg-green-600 border-green-600 dark:border-green-600 !rounded-full w-full text-center py-2.5 !text-white hover:!text-white">
                                    <i className="mdi mdi-phone me-2"></i>+420 733 781 696
                                </Link>
                            </li>
                        </ul>
                    </SimpleBar>
