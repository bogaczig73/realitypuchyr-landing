                            ...
                            <div className="relative w-full">
                                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px] -mt-24">
                                    <div className="lg:col-span-4 md:col-span-12">
                                        ...
                                        <p className="mt-6 text-gray-300">I take care of my clients' assets — providing expert broker consulting to protect and grow their wealth.</p>

                                    </div>

                                    <div className="lg:col-span-2 md:col-span-4">
                                        <h5 className="tracking-[1px] text-gray-100 font-semibold">Sitemap</h5>
                                        <ul className="list-none footer-list mt-6">
                                            <li><Link href="/list" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Listing</span> </Link></li>
                                            <li className="mt-[10px]"><Link href="#services" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Services</span> </Link></li>
                                            ...
                                            <li className="mt-[10px]"><Link href="/blog" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Blog</span> </Link></li>
                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <ul className="list-none footer-list mt-6">
                                              <li><Link href="/blog/1" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Blog post</span> </Link></li>
                                              <li className="mt-[10px]"><Link href="/blog/2" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span>Blog post</span> </Link></li>
                                              <li className="mt-[10px]"><Link href="/terms" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out flex items-center"><FiChevronRight width={18} className="me-1"/> <span> Terms of Services</span> </Link></li>
                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <div className="flex mt-6">
                                            ...
                                            <div className="">
                                                <h6 className="text-gray-300 mb-2">Šimáčkova 916/13, <br/> 170 00 Praha 7-Holešovice, <br/>Czechia</h6>
                                                <Link href="https://maps.app.goo.gl/9YwTpPK67SnaomM36" data-type="iframe" className="text-green-600 hover:text-green-700 duration-500 ease-in-out lightbox">View on Google map</Link>
                                            </div>
                                        </div>
